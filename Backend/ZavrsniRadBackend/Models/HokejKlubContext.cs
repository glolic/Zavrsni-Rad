...
namespace ZavrsniRadBackend.Models
{
    public partial class HokejKlubContext : DbContext
    {
        ...
        public virtual DbSet<DrzavaOsobe> DrzavaOsobe { get; set; }
        ...
        {
            modelBuilder.Entity<DrzavaOsobe>(entity =>
            {
                entity.ToTable("drzavaOsobe");
                ...
                entity.HasOne(d => d.Drzava)
                    .WithMany(p => p.DrzavaOsobe)
                    .HasForeignKey(d => d.DrzavaId)
                    .HasConstraintName("FK_drzavaOsobe_drzave");

                entity.HasOne(d => d.Osoba)
                    .WithMany(p => p.DrzavaOsobe)
                    .HasForeignKey(d => d.OsobaId)
                    .HasConstraintName("FK_drzavaOsobe_Osoba");
            });
